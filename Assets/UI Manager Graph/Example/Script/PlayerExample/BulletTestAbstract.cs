...
namespace Com.Github.Knose1.Flow.Example.BulletExample
{
	...
	public class BulletTestAbstract : StateMachine
	{
		...
		protected MachineState stateState;
		...
		protected override void SetupMachine()
		{
			...
			stateState = new MachineState("State");
			...
			two1State.AddTrigger("Time",two1State, false);
			two1State.AddTrigger("Time2",stateState, false);
			stateState.AddTrigger("Time2",oneState, false);
